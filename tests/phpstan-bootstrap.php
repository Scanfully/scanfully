...
// WordPress defines these in wp-config.php / wp-settings.php at runtime. Their
// types are pinned under `dynamicConstantNames` in phpstan.neon.dist, so the
// values below are never treated as fixed.
if ( ! defined( 'WP_CACHE' ) ) {
